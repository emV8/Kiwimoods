...
<div id = "currentMood">
	<form action="currentmood.php" method="post">
		...
		<div id="other"> <img src="img/music/blanc.png" width="25%" alt="autre"> <br/> Autre <br/> <span class ="radiomood"> <input type='radio' name="mood" value='autre' /> </span> <br/> <input type="text" name="otherMood" id = "otherMood" style="width:50%; position:relative; left:-10%;"/> </div>
